        ...
        <div class="modal-content">
            <form action="{{ route('addRating') }}" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn-close2 btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    ...
                    <table class="table table-borderless">
                        @foreach ($orders as $order)
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <p>Tanggal Order : {{ date('d-m-Y', strtotime($order->created_at)) }}</p>
                                        <p>Nomor Resi : {{ $order->no_resi }}</p>
